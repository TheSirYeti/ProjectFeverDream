...
public enum SoundID
{
    ...
    ENEMY_DETECT_6,
    ENEMY_DETECT_7,
    ASSISTANT_INTERACT_01,
    ASSISTANT_INTERACT_02,
    ASSISTANT_INTERACT_03,
    ASSISTANT_INTERACT_04,
    ASSISTANT_INTERACT_05,
    ASSISTANT_INTERACT_06,
    ASSISTANT_INTERACT_07,
    ASSISTANT_INTERACT_08,
    ASSISTANT_EAT_01,
    ASSISTANT_EAT_02,
    ASSISTANT_EAT_03,
    ASSISTANT_EAT_04,
