...
public class StoveStation : GenericObject, IWorkstation
{
    ...
    {
        if (!_isOccupied && ingredient.GetCookingType() == CookingType.STOVE) 
            StartCoroutine(DoStoveCooking(ingredient));
    }
