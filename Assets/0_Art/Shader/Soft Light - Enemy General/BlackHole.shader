...
Shader "BlackHole"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 OffsetWarning643 = ( ( ase_vertexNormal * sin( ( ( v.texcoord.xy.y + mulTime604 ) * ( _ValueWarning * 500.0 ) ) ) ) * float3(1,0,0) * 1.0 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			float4 HalfLambert445 = saturate( ( saturate( ( color660 * (dotResult440*_HalfLambert + _HalfLambert) ) ) * float4( ase_lightColor.rgb , 0.0 ) * ase_lightColor.a * ase_lightAtten ) );
...
/*ASEBEGIN
Version=18900
0;73;994;655;2026.357;3882.402;3.433401;False;False
...
Node;AmplifyShaderEditor.Vector3Node;516;-2925.086,-2905.517;Inherit;False;Property;_BlackHolePosition;Black Hole Position;18;0;Create;True;0;0;0;False;0;False;0,0,0;-5.453,7.94,17.419;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.LightAttenuation;654;250.3925,-2488.329;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;474;547.0256,-2739.346;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=41169BFF94B6BA1CD17C45FDC1B92ACD7BF63AD3