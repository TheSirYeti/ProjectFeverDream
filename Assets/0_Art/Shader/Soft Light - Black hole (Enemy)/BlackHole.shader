...
Shader "BlackHole"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 OffsetWarning643 = ( ( ase_vertexNormal * sin( ( ( v.texcoord.xy.y + mulTime604 ) * ( _ValueWarning * 500.0 ) ) ) ) * float3(1,1,1) * 1.0 );
...
/*ASEBEGIN
Version=18900
0;73;1109;584;2324.786;2017.553;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;648;-1636.098,-1782.786;Inherit;False;Constant;_Warningposition;Warning position;21;0;Create;True;0;0;0;False;0;False;1,1,1;2,1,2;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=110B8E7D5D11869EDE60C0E8FA352B8FBD1CE7B7