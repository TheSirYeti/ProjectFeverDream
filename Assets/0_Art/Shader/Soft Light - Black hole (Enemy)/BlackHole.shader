...
Shader "BlackHole"
{
	Properties
	{
		...
		_Minshadow("Min shadow", Float) = -0.5
		_Maxshadow("Max shadow", Float) = 1
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_383_0 = ( _BlackHolePosition - ase_worldPos );
			float lerpResult387 = lerp( 0.0 , _Range , _Effect);
			float clampResult391 = clamp( ( lerpResult387 - length( temp_output_383_0 ) ) , 0.0 , 1.0 );
			float3 BlackHole394 = ( ( float3( 0,0,0 ) + temp_output_383_0 ) * clampResult391 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult376 = smoothstep( _Minshadow , _Maxshadow , saturate( ( ase_lightAtten + _Shadow ) ));
...
/*ASEBEGIN
Version=18900
0;73;1005;655;2489.526;3383.107;1.3;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;373;-1303.211,-3382.204;Inherit;False;Property;_Shadow;Shadow;5;0;Create;True;0;0;0;False;0;False;0;0.7532959;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;412;36.21091,-3589.873;Inherit;False;Property;_Specularsomething;Specular something;12;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;407;134.2109,-3492.873;Inherit;False;Property;_ColorSpecular;Color Specular;11;2;[HDR];[Header];Create;True;1;Specular;0;0;False;0;False;0,0,0,0;0.6666667,0.8117648,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;378;-1013.269,-3301.701;Inherit;False;Property;_Maxshadow;Max shadow;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;423;-1264.972,-2831.33;Inherit;False;Property;_FresnelScale;Fresnel Scale;16;0;Create;True;0;0;0;False;0;False;0;0.95;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;377;-1010.269,-3376.701;Inherit;False;Property;_Minshadow;Min shadow;6;0;Create;True;0;0;0;False;0;False;-0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;424;-1266.803,-2754.247;Inherit;False;Property;_FresnelPower;Fresnel Power;17;0;Create;True;0;0;0;False;0;False;0;4.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;382;-2608.804,-3009.826;Inherit;False;Property;_BlackHolePosition;Black Hole Position;8;1;[Header];Create;True;1;Black hole;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;389;-2617.152,-2632.925;Inherit;False;Property;_Effect;Effect;10;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;388;-2614.752,-2709.325;Inherit;False;Property;_Range;Range;9;0;Create;True;0;0;0;False;0;False;0;4.51;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;419;-1072.221,-2687.862;Inherit;False;Property;_FresnelIntesity;Fresnel Intesity;15;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;461;-1075.326,-3073.856;Inherit;False;Property;_ColorFresnel;Color Fresnel;14;2;[HDR];[Header];Create;True;1;Fresnel;0;0;False;0;False;0,0,0,0;0.4392157,0.7960785,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;414;488.719,-3639.414;Inherit;False;Property;_IntensitySpecular;Intensity Specular;13;0;Create;True;0;0;0;False;0;False;0.1;0.1309912;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;383;-2337.902,-2943.885;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LengthOpNode;385;-2181.053,-2907.024;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;487;679.4617,-2753.446;Inherit;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;430;-135.0577,-2998.083;Inherit;False;Property;_TurningOFF;Turning OFF;18;1;[Header];Create;True;1;Gradient;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;386;-2094.655,-2737.124;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;392;-1875.844,-3020.381;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;393;-1719.841,-3020.683;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;394;-1575.672,-3027.965;Inherit;False;BlackHole;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=FDDEEB6FB2C4750B81A6EAAF07DF5DEC29527122