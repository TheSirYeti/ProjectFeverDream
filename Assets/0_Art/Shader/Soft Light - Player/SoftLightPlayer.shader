...
Shader "SoftLightPlayer"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float HalfLambert204 = (dotResult199*_Value + _Value);
			...
			float dotResult142 = dot( Metallic_Smoothness126 , temp_cast_1 );
			...
			float dotResult150 = dot( ( ase_worldViewDir + _WorldSpaceLightPos0.xyz ) , WorldNormal127 );
			...
			c.rgb = ( ( Albedo125 * HalfLambert204 * float4( ( Sature_Color_Smooth145 + Shadow181 ) , 0.0 ) ) + Fresnel195 + Specular171 ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18900
0;73;924;637;4519.083;3458.365;5.839554;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;172;-1537.22,-1479.898;Inherit;False;1824.918;627;;19;167;154;158;162;163;164;161;157;168;169;170;151;150;148;147;159;149;152;171;Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldSpaceLightPos;149;-1487.22,-1271.863;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-1499.814,-1628.641;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;205;-2864.778,-958.6785;Inherit;False;974.7129;335.418;;6;197;199;200;202;204;220;Half Lambert;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;204;-2114.065,-908.6785;Inherit;False;HalfLambert;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;207;-166.1208,-514.8525;Inherit;False;204;HalfLambert;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;210;73.87921,-564.8525;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=E2163EB75E6E652311F3519BE44318A2D5A44C77