...
Shader "BlackHole_HEAD"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_TexCoord664 = i.uv_texcoord * ( float2( 0,0.75 ) + 0.25 ) + ( 0.25 * _MoveFace );
...
/*ASEBEGIN
Version=18900
0;73;994;655;2013.05;3991.492;4.210322;False;False
...
ASEEND*/
//CHKSM=B5B68DFD1D4B610F244073885C20867671497818