...
Shader "BlackHole_HEAD"
{
	Properties
	{
		...
		_Tilling("Tilling", Vector) = (0,1,0,0)
		_PointOffset("Point Offset", Float) = 0
		_Warningposition("Warning position", Vector) = (1,1,1,0)
		_ControlFace("Control Face", Range( 0 , 3)) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float3 temp_cast_0 = (_TurningOFF).xxx;
			float grayscale462 = Luminance(temp_cast_0);
			float Gradient432 = grayscale462;
			float2 uv_TexCoord759 = i.uv_texcoord + float2( 0.5,0.5 );
			float2 temp_cast_2 = (uv_TexCoord759.y).xx;
			float2 panner802 = ( _Time.y * float2( 0,2 ) + temp_cast_2);
			float simplePerlin2D761 = snoise( panner802*_StaticChangeFace );
			simplePerlin2D761 = simplePerlin2D761*0.5 + 0.5;
			float2 uv_TexCoord664 = i.uv_texcoord * ( _Tilling + _PointOffset ) + ( ( _PointOffset * _MoveFace * ( ( _MoveFace + float2( -1,0 ) ).x + _ControlFace ) ) + (( simplePerlin2D761 * 0.1 )*0.5 + _Vector0.x) );
			...
			float4 temp_cast_5 = (_Smoothness).xxxx;
			float dotResult367 = dot( Metallic_Smoothness357 , temp_cast_5 );
...
/*ASEBEGIN
Version=18900
0;73;994;655;4536.611;4293.358;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;707;-4198.82,-3997.418;Inherit;False;Property;_MoveFace;Move Face;19;0;Create;True;0;0;0;False;0;False;0,-0.01;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;763;-4687.576,-3435.832;Inherit;False;Property;_StaticChangeFace;Static Change Face;25;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;741;-4090.635,-3768.142;Inherit;False;Property;_ControlFace;Control Face;24;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;793;-3874.524,-3598.273;Inherit;False;Property;_Vector0;Vector 0;26;0;Create;True;0;0;0;False;0;False;0,0;-0.025,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;669;-3876.482,-4075.144;Inherit;False;Property;_PointOffset;Point Offset;22;0;Create;True;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;668;-3873.893,-4206.835;Inherit;False;Property;_Tilling;Tilling;21;0;Create;True;0;0;0;False;0;False;0,1;0,0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;729;-2890.653,-4422.757;Inherit;False;Property;_ColorFace;Color Face;20;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;648;-1636.098,-1782.786;Inherit;False;Property;_Warningposition;Warning position;23;0;Create;True;0;0;0;False;0;False;1,1,1;1,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=AE04A95C8CE8A0281BA056253FC4B69EFBB87ABD