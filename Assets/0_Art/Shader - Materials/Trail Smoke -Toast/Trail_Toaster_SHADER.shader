		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 temp_output_37_0 = ( saturate( ( ( i.color * _Saturacion ) * _Color0 ) ) * ( saturate( (temp_cast_2 + (( tex2D( _Noise, texCoord17 ) + ( 1.0 - texCoord23.y ) ) - temp_cast_0) * (temp_cast_3 - temp_cast_2) / (temp_cast_1 - temp_cast_0)) ) * saturate( tex2D( _TextureSample0, rotator6 ) ) ) );
...
/*ASEBEGIN
Version=18900
0;73;982;585;418.0456;981.7726;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1633.135,-9.044739;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;38;-208.5334,-1040.832;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-171.1073,-832.1849;Inherit;False;Property;_Saturacion;Saturacion;8;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;42;0.3873291,-765.0092;Inherit;False;Property;_Color0;Color 0;9;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;7.885769,-1031.388;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;115.8184,-922.6541;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;43;318.9544,-751.7726;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;410.6687,-565.6148;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=011CB5A904C6297BF7D3D6AA421EF8A9F66D19AF