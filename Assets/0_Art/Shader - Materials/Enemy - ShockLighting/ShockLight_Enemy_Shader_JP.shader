		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					Gradient gradient32 = NewGradient( 0, 5, 2, float4( 0, 0.4233643, 0.4352941, 0 ), float4( 0, 0.6004929, 0.7058824, 0.08824293 ), float4( 0, 0.8987775, 0.972549, 0.2764782 ), float4( 0.5921569, 0.8560442, 0.9960784, 0.4941176 ), float4( 1, 0.9556705, 0.9103774, 1 ), 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
/*ASEBEGIN
Version=18900
993;73;649;617;1268.962;744.7245;1.05908;False;False
...
Node;AmplifyShaderEditor.GradientNode;32;-1192.379,-500.7637;Inherit;False;0;5;2;0,0.4233643,0.4352941,0;0,0.6004929,0.7058824,0.08824293;0,0.8987775,0.972549,0.2764782;0.5921569,0.8560442,0.9960784,0.4941176;1,0.9556705,0.9103774,1;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=D39E2C9A2858D3DE195148E8B20E9E5B940F7911