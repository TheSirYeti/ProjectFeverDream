...
Shader "Vaccum_Cone_Shader"
{
	Properties
	{
		...
		_OpacityExternal("OpacityExternal", Range( 0 , 0.81)) = 1
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 temp_output_3_0 = saturate( ( ( tex2D( _Noisetwo, texCoord49 ) + _Float0 ) + (temp_cast_2 + (tex2D( _Noiseone, texCoord5 ) - temp_cast_0) * (temp_cast_3 - temp_cast_2) / (temp_cast_1 - temp_cast_0)) ) );
...
/*ASEBEGIN
Version=18900
0;73;1105;629;1949.58;-458.5207;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-2150.112,-579.7304;Inherit;False;Property;_SpeedNoisetwo;Speed Noise two;9;0;Create;True;0;0;0;False;0;False;0;0.3529412;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;51;-1867.456,-574.0408;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;47;-1871.468,-723.9193;Inherit;False;Constant;_OffsetTillingtwo;Offset Tilling two;3;0;Create;True;0;0;0;False;0;False;1,-1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;48;-1773.495,-925.6356;Inherit;False;Property;_TllingNoisetwo;Tlling Noise two;3;0;Create;True;0;0;0;False;0;False;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-1663.904,-683.4116;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;49;-1500.162,-738.0222;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;32;-1435.776,667.0514;Inherit;False;28;V_Texcoord;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-1123.731,-424.8529;Inherit;False;Property;_Float0;Float 0;15;0;Create;True;0;0;0;False;0;False;0;0.11;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;45;-1235.507,-671.4153;Inherit;True;Property;_Noisetwo;Noise two;14;0;Create;True;0;0;0;False;0;False;-1;None;7e4ac535c04ac8a40aeef9e10ddb297c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-1512.575,868.2722;Inherit;False;Property;_OpacityExternal;OpacityExternal;11;0;Create;True;0;0;0;False;0;False;1;0.81;0;0.81;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;89;-893.0754,-475.2013;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;46;-773.8237,-334.0745;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;60;-396.0543,-456.1602;Inherit;False;Property;_Base;Base;19;0;Create;True;0;0;0;False;0;False;0.7877358,0.9796853,1,0;0.8117647,0.9254902,0.972549,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SinOpNode;21;-660.0162,356.0928;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=24E6BC6391C642A2D7F68E6973CE772D43C12D53