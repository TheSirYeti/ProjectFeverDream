...
Shader "SC_StylizedEnemy_MAT"
{
	Properties
	{
		...
		_Float2("Float 2", Float) = 3.14
		_Float4("Float 4", Float) = 1.07
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float fresnelNode166 = ( 0.0 + _Float3 * pow( 1.0 - fresnelNdotV166, _Float2 ) );
			float4 color167 = IsGammaSpace() ? float4(1,0,0.008883953,0) : float4(1,0,0.0006876125,0);
			float mulTime213 = _Time.y * _SpeedCorners;
			float lerpResult218 = lerp( _Float1 , _Float4 , sin( ( 1.0 * mulTime213 ) ));
			...
			float simplePerlin2D174 = snoise( ( transform190 + mulTime186 ).xy*_Float0 );
			...
			v.vertex.xyz += ( float4( ase_vertexNormal , 0.0 ) * ( temp_output_177_0 * _Float5 ) ).rgb;
			v.vertex.w = 1;
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 M_Basecolor50 = ( temp_output_49_0 * saturate( ( temp_output_49_0 * 4.55 ) ) );
			...
			c.rgb = saturate( ( N_Rim99 + ( float4( N_Light54 , 0.0 ) * M_Basecolor50 ) + N_Specular130 + FresnelWarning172 ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18900
0;73;814;576;-907.5168;212.9034;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-2077.932,1166.289;Inherit;False;Property;_SpeedCorners;Speed Corners;4;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;163;-1193.763,727.1077;Inherit;False;1951.677;999.1895;;20;171;170;176;190;175;178;172;177;174;188;169;186;168;166;187;167;165;164;196;219;Heavy attack JP;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-1619.518,956.2471;Inherit;False;Property;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;1;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;217;-1627.518,1036.247;Inherit;False;Property;_Float4;Float 4;9;0;Create;True;0;0;0;False;0;False;1.07;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-1232.557,-1067.742;Inherit;False;Property;_RimOffset;Rim Offset;11;0;Create;True;0;0;0;False;0;False;1;2.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-1143.763,923.5316;Inherit;False;Property;_Float2;Float 2;8;0;Create;True;0;0;0;False;0;False;3.14;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;165;-1143.361,840.7867;Inherit;False;Property;_Float3;Float 3;3;0;Create;True;0;0;0;False;0;False;1;1.94;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;154;-794.6892,45.29242;Inherit;False;Property;_SpecularPower;Specular Power;15;1;[Header];Create;True;1;Specular;0;0;False;0;False;0;0.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;162;-832.4504,168.5938;Inherit;False;Property;_Color0;Color0;21;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7913849,0.9489836,0.9811321,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;63;-309.5435,-1629.115;Inherit;False;45;M_Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;156;-586.6892,88.29242;Inherit;False;Property;_Max;Max;17;0;Create;True;0;0;0;False;0;False;0;1.17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;102;-851.7081,-628.2919;Inherit;False;Property;_RimColor;Rim Color;12;1;[HDR];Create;True;0;0;0;False;0;False;1,0.8242262,0.5896226,0;0.740566,0.8312773,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-1902.039,-1778.014;Inherit;False;Constant;_Sature;Sature;5;0;Create;True;0;0;0;False;0;False;4.55;4.55;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;155;-582.6892,18.29242;Inherit;False;Property;_Min;Min;16;0;Create;True;0;0;0;False;0;False;0;1.07;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;187;-1033.157,1400.385;Inherit;False;Property;_SpeedWarning;Speed Warning;23;0;Create;True;0;0;0;False;0;False;0;0.227;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-219.6764,-1839.728;Inherit;False;Property;_LightValue;Light Value;19;1;[Header];Create;True;1;Lighting;0;0;False;0;False;0;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;97;-866.08,-1054.77;Inherit;False;Property;_RimPower;Rim Power;10;1;[Header];Create;True;1;Rim Value;0;0;False;0;False;0.4810303;0.84;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;159;-226.6764,-1768.728;Inherit;False;Property;_ShadowValue;Shadow Value;20;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-611.5999,1462.692;Inherit;False;Property;_Float0;Float 0;22;0;Create;True;0;0;0;False;0;False;5;239;0;300;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-111.5983,1138.048;Inherit;False;Property;_ValueWarning;Value Warning;14;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;157;-235.0266,126.2118;Inherit;False;Property;_SpecularIntesity;Specular Intesity;18;0;Create;True;0;0;0;False;0;False;0;0.16;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-290.7443,-1003.764;Inherit;False;Property;_RimIntensity;Rim Intensity;13;0;Create;True;0;0;0;False;0;False;1;0.95;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;177;288.1343,1226.371;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;56;950.0222,-1341.63;Inherit;False;54;N_Light;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;52;952.7295,-1252.027;Inherit;False;50;M_Basecolor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;172;444.2889,797.2205;Inherit;False;FresnelWarning;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;173;1150.05,-1095.189;Inherit;False;172;FresnelWarning;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;1144.374,-1289.418;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;221;1310.593,93.45931;Inherit;False;Property;_Float5;Float 5;24;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;132;1143.512,-1185.137;Inherit;False;130;N_Specular;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;109;1146.937,-1380.01;Inherit;False;99;N_Rim;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;1507.064,-214.9801;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;108;1331.596,-1339.771;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NormalVertexDataNode;222;1277.738,-471.2142;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;32;1468.45,-1300.112;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-1042.284,-1711.244;Inherit;False;Property;_OutlineWidth;Outline Width;5;1;[Header];Create;True;1;Outline;0;0;False;0;False;0;0.0015;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;223;1592.926,-383.8834;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;72;1430.915,-995.6237;Inherit;False;70;N_Outline;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;68;-1061.561,-1908.202;Inherit;False;Property;_ColorOutline;Color Outline;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.02624358,0.1603774,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;115;-2221.474,-2100.164;Inherit;False;1043.589;737.5994;Comment;0;Texture;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;73;-1111.561,-1960.925;Inherit;False;726.1443;328.443;;0;Outline;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;66;-359.5435,-1964.462;Inherit;False;1115.114;638.0347;;0;Lighting;1,1,1,1;0;0
...
WireConnection;6;11;223;0
ASEEND*/
//CHKSM=25E624856ECCF77E20AF372B9B94BFAA788FB4FE