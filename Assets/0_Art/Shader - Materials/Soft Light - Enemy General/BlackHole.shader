...
Shader "BlackHole"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 WorldNormal356 = (WorldNormalVector( i , UnpackNormal( tex2D( _TextureSample0, uv_TextureSample0 ) ).rgb ));
...
/*ASEBEGIN
Version=18900
685;73;957;557;2892.152;4211.72;1.898003;False;False
...
Node;AmplifyShaderEditor.ColorNode;407;134.2109,-3492.873;Inherit;False;Property;_ColorSpecular;Color Specular;8;2;[HDR];[Header];Create;True;1;Specular;0;0;False;0;False;0,0,0,0;0.3301887,0.3301887,0.3301887,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=97FCDBE3ECA30DC78F01BF77BB7258BA1A97B6B6