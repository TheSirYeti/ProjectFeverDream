...
Shader "Weapon_Shader_MAT"
{
	Properties
	{
		...
		_FresnelBias1("Fresnel Bias", Float) = -0.13
		_FresnelScale1("Fresnel Scale", Float) = 1.87
		_FresnelPower1("Fresnel Power", Float) = 3
		_FresnelIntesity1("Fresnel Intesity", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform float _FresnelIntesity1;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelNode8 = ( _FresnelBias1 + _FresnelScale1 * pow( 1.0 - fresnelNdotV8, _FresnelPower1 ) );
			o.Emission = saturate( ( saturate( _ColorFresnel ) * fresnelNode8 * _FresnelIntesity1 ) ).rgb;
...
/*ASEBEGIN
Version=18900
0;73;753;573;1362.648;411.93;2.16851;False;False
Node;AmplifyShaderEditor.ColorNode;4;-633.125,12.76926;Inherit;False;Property;_ColorFresnel;Color Fresnel;3;1;[Header];Create;True;1;Fresnel;0;0;False;0;False;1,1,1,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-841.1882,200.509;Inherit;False;Property;_FresnelBias1;Fresnel Bias;4;0;Create;True;0;0;0;False;0;False;-0.13;-0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-840.1882,283.5095;Inherit;False;Property;_FresnelScale1;Fresnel Scale;5;0;Create;True;0;0;0;False;0;False;1.87;4.24;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-841.1882,359.5093;Inherit;False;Property;_FresnelPower1;Fresnel Power;6;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;6;-408.3041,17.75543;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;8;-621.3041,186.7551;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-581.9078,368.9036;Inherit;False;Property;_FresnelIntesity1;Fresnel Intesity;7;0;Create;True;0;0;0;False;0;False;0;0.07048769;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FC34F2F2AE29B66196BFE07EF09CEBA1B92C9803