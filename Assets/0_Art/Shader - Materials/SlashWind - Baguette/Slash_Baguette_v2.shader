...
Shader "Slash_Baguette_v2"
{
	Properties
	{
		...
		_EmissionFloat("Emission Float", Range( 0 , 5)) = 0
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 appendResult7 = (float4(( ( _ShadowColor * RGB_VertexColor103 ) + ( saturate( (temp_cast_4 + (tex2D( _Emission, OffSetMove108 ) - temp_cast_2) * (temp_cast_5 - temp_cast_4) / (temp_cast_3 - temp_cast_2)) ) * _EmissionFloat * RGB_VertexColor103 ) ).rgb , ( screenPos.y * ( saturate( ( ( ( tex2D( _Main, OffSetMove108 ) * _Opacity ) + _SubMain ) * _Exp ) ) * ALPHA_VertexColor104 * Dissolve98 * Mask_Border171 ) ).r));
...
/*ASEBEGIN
Version=18900
0;73;747;741;1951.633;1517.329;2.833729;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;175;-2606.23,1307.521;Inherit;False;Property;_MaskRight;Mask Right;11;0;Create;True;0;0;0;False;0;False;1.73;1.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;170;-2605.106,1225.174;Inherit;False;168;Texcoord_V;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;173;-2554.899,1009.55;Inherit;False;Property;_MaskLeft;Mask Left;9;0;Create;True;0;0;0;False;0;False;1.68;1.68;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;174;-2257.624,1144.544;Inherit;False;Property;_IntensityMaskL;Intensity Mask L;10;0;Create;True;0;0;0;False;0;False;4.53;4.53;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;176;-2228.8,1452.838;Inherit;False;Property;_IntensityMaskR;Intensity Mask R;12;0;Create;True;0;0;0;False;0;False;5.11;5.11;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;112;-1935.729,-789.7342;Inherit;False;1326.277;1030.194;Comment;22;2;4;3;51;54;52;58;60;106;61;102;103;104;110;109;57;107;56;194;201;200;208;Texture Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1642.716,123.46;Inherit;False;Property;_Opacity;Opacity;1;0;Create;True;0;0;0;False;0;False;0;10.47857;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;200;-1300.555,79.95406;Inherit;False;Property;_SubMain;Sub Main;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;208;-1094.065,118.3104;Inherit;False;Property;_Exp;Exp;14;0;Create;True;0;0;0;False;0;False;0;3.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;201;-1161.375,-73.76009;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;51;-1703.523,-475.0055;Inherit;True;Property;_Emission;Emission;4;0;Create;True;0;0;0;False;0;False;-1;None;df7238bb516e617438fffce00e67a451;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;210;-934.0652,-5.689575;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1134.702,-389.0732;Inherit;False;Property;_EmissionFloat;Emission Float;5;0;Create;True;0;0;0;False;0;False;0;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;60;-1181.345,-739.7342;Inherit;False;Property;_ShadowColor;Shadow Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7254902,0.9098039,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;194;-793.6345,-74.49045;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;62;-403.4305,-508.64;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=56DB4719C4380BF3FD621C6B0A0C7B1B5D106063